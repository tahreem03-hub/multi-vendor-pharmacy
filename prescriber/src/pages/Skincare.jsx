...
import { Search, SlidersHorizontal, ChevronRight, ShoppingBag, Package } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50 font-sans">
      ...
      <div className="bg-black text-white py-10 px-6 md:px-20">
        <div className="max-w-7xl mx-auto">
          ...
          <h1 className="text-3xl md:text-4xl font-black tracking-tight mb-2">Skincare</h1>
                    ...
                    <div className="p-4 border-t border-gray-50">
                      ...
                      <div className="flex items-center justify-between gap-2">
                        <span className="text-base font-black text-black">
                          Â£{(item.sellingPrice || item.price || 0).toFixed(2)}
                        </span>
                        <button
