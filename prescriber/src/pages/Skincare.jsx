...
import { Search, SlidersHorizontal, ChevronRight, ShoppingBag, Package, Filter } from 'lucide-react';
    ...
    <div className="min-h-screen" style={{ backgroundColor: COLORS.lightBg }}>
      ...
      <div style={{ backgroundColor: COLORS.secondary }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          {/* Title - Always shows "Skincare" and description changes based on subcategory */}
