            ...
            {subCategoriesList.map((sub) => {
              ...
              return (
                <button
                  ...
                  className={`px-3 sm:px-4 md:px-6 py-1.5 sm:py-2 md:py-2.5 text-[11px] sm:text-xs md:text-sm font-medium rounded-full transition-all duration-200 whitespace-nowrap flex-shrink-0
                    ${isActive
